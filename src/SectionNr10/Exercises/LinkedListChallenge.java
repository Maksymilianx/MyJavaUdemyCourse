...
public class LinkedListChallenge {
    ...
    public static void main(String[] args) {
        ...
        addPlace(placesToVisit, new Place("Brisbane", 999));
        addPlace(placesToVisit, new Place("Perth", 3491));
        addPlace(placesToVisit, new Place("Alice Springs", 2771));
        addPlace(placesToVisit, new Place("Darwin", 3912));
        ...
        while (!quitLoop) {
            ...
            switch (menuItem) {
                case "F" -> {
                    ...
                    if (!forward) {         // reversing Ditection
                        forward = true;
                        if (iterator.hasNext()) {
